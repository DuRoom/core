...
interface DriverInterface
{
     ...
     * Settings and configuration can either be pulled from the DuRoom settings repository
     ...
     * like `duroom-assets` or `duroom-avatars`.
     *
     ...
     * @param SettingsRepositoryInterface $settings: An instance of the DuRoom settings repository.
