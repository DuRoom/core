...
namespace DuRoom\Frontend\Content;

use DuRoom\Foundation\Config;
use DuRoom\Frontend\Compiler\CompilerInterface;
...
class Assets
{
    ...
    {
        $this->assets = $this->container->make('duroom.assets.'.$name);
