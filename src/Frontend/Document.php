...
/**
 * A view which renders a HTML skeleton for DuRoom's frontend app.
 */
class Document implements Renderable
{
     ...
     * @var string
     */
    public $appView = 'duroom::frontend.app';
     ...
     * @var string
     */
    public $contentView = 'duroom::frontend.content';
    ...
    /**
     * Other variables to preload into the DuRoom JS.
     *
     * @var array
     */
    public $payload = [];
