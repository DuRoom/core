...
use DuRoom\Extension\Exception as ExtensionException;
use DuRoom\Foundation\ErrorHandling as Handling;
...
class ErrorServiceProvider extends AbstractServiceProvider
{
    ...
    {
        $this->container->singleton('duroom.error.statuses', function () {
            return [
                // 400 Bad Request
        ...
        $this->container->singleton('duroom.error.classes', function () {
            return [
        ...
        $this->container->singleton('duroom.error.handlers', function () {
            return [
        ...
        $this->container->singleton(Handling\Registry::class, function () {
            return new Handling\Registry(
                $this->container->make('duroom.error.statuses'),
                $this->container->make('duroom.error.classes'),
                $this->container->make('duroom.error.handlers')
            );
        });
