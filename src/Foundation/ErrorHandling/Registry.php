...
/**
 * DuRoom's central registry of known error types.
 *
 * It knows how to deal with errors raised both within DuRoom's core and outside
...
class Registry
{
     ...
     *
     * This can map internal ({@see \DuRoom\Foundation\KnownError}) as well as
     * external exceptions (any classes inheriting from \Throwable) to instances
     * of {@see \DuRoom\Foundation\ErrorHandling\HandledError}.
     *
