...
class Application
{
    ...
    /**
     * The IoC container for the DuRoom application.
     *
     * @var Container
     */
    private $container;
    ...
    /**
     * The paths for the DuRoom installation.
     *
     * @var Paths
     */
    protected $paths;
    ...
    /**
     * Create a new DuRoom application instance.
     *
    ...
    {
        $config = $this->container->make('duroom.config');

        return $config[$key] ?? $default;
    }

    /**
     * Check if DuRoom is in debug mode.
     *
     * @return bool
     */
    ...
    /**
     * Get the URL to the DuRoom installation.
     *
     * @param string $path
     * @return string
     */
    ...
    protected function registerBaseBindings()
    {
         ...
         * Use container inside duroom instead.
         */
        ...
        $this->container->instance('duroom', $this);
        $this->container->alias('duroom', self::class);

        $this->container->instance('duroom.paths', $this->paths);
        $this->container->alias('duroom.paths', Paths::class);
    }
