 ...
 * using one of Laravel's various email drivers throughout DuRoom.
 *
 * @public
 */
interface DriverInterface
{
     ...
     * values stored in DuRoom's settings are "valid" as far as a simple
     ...
     * presence of validation problems with the configured mail driver, DuRoom
     * will fall back to its no-op {@see \DuRoom\Mail\NullDriver}.
     */
    ...
    /**
     * Build a mail transport based on DuRoom's current settings.
     */
