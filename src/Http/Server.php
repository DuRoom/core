...
use DuRoom\Foundation\ErrorHandling\LogReporter;
...
class Server
{
    ...
    /**
     * Try to boot DuRoom, and retrieve the app's HTTP request handler.
     *
    ...
    {
        if (app()->has('duroom.config') && app('duroom.config')->inDebugMode()) {
            ...
            echo <<<ERROR
            DuRoom encountered a boot error ($type)<br />
            <b>$message</b><br />
...
ERROR;
            ...
            echo 'DuRoom encountered a boot error. Details have been logged to the DuRoom log file.';
            exit(1);
        }
    }
    ...
    {
        echo 'DuRoom encountered a boot error. Details have been logged to the system PHP log file.<br />';
