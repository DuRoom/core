...
namespace DuRoom\Install\Prerequisite;
        ...
        return $this->paths
            ->filter(function ($path) {
                ...
                return [
                    ...
                    'detail' => 'Please make sure your web server/PHP user has write access to this directory'.(in_array($index, $this->wildcards) ? ' and its contents' : '').'. Read the <a href="https://duroom.js.org/docs/install/#folder-ownership">installation documentation</a> for a detailed explanation and steps to resolve this error.'
                ];
            });
    }
