...
use DuRoom\User\Event\Activated;
use DuRoom\User\Event\AvatarChanged;
use DuRoom\User\Event\Deleted;
use DuRoom\User\Event\EmailChanged;
use DuRoom\User\Event\EmailChangeRequested;
use DuRoom\User\Event\PasswordChanged;
use DuRoom\User\Event\Registered;
use DuRoom\User\Event\Renamed;
...
class User extends AbstractModel
{
    ...
    public function getAvatarUrlAttribute(string $value = null)
    {
        if ($value && strpos($value, '://') === false) {
            return resolve(Factory::class)->disk('duroom-avatars')->url($value);
        }
