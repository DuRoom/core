...
class QueueServiceProvider extends AbstractServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->container->singleton(Factory::class, function (Container $container) {
            return new QueueFactory(function () use ($container) {
                return $container->make('duroom.queue.connection');
            });
        });

        // Extensions can override this binding if they want to make DuRoom use
        // a different queuing backend.
        $this->container->singleton('duroom.queue.connection', function (Container $container) {
            $queue = new SyncQueue;
        ...
        // option and force the binary to duroom.
        ...
        $this->container->alias('duroom.queue.connection', Queue::class);
    ...
    {
        $this->container->extend('duroom.console.commands', function ($commands, Container $container) {
