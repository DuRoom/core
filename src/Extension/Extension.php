...
use DuRoom\Extend\LifecycleInterface;
use DuRoom\Extension\Exception\ExtensionBootError;
...
class Extension implements Arrayable
{
    ...
    /**
     * The IDs of all DuRoom extensions that this extension depends on.
     *
     * @var string[]
     */
    ...
    /**
     * The IDs of all DuRoom extensions that this extension should be booted after
     * if enabled.
     *
     * @var string[]
     */
    ...
    protected static function nameToId($name)
    {
        ...
        $package = str_replace(['duroom-ext-', 'duroom-'], '', $package);
    ...
    /**
     * Get the list of duroom extensions that this extension depends on.
     *
    ...
    public function calculateDependencies($extensionSet, $enabledIds)
    {
        ...
        $this->optionalDependencyIds = (new Collection(Arr::get($this->composerJson, 'extra.duroom-extension.optional-dependencies', [])))
            ->map(function ($key) {
                return static::nameToId($key);
            })
    ...
    {
        $icon = $this->composerJsonAttribute('extra.duroom-extension.icon');
    ...
    {
        return $this->composerJsonAttribute('extra.duroom-extension.title');
    }
    ...
    public function getLinks()
    {
        ...
        return array_merge($links, $this->composerJsonAttribute('extra.duroom-extension.links') ?? []);
    }
