...
use DuRoom\Http\Exception\RouteNotFoundException;
...
class Discussion
{
    ...
    public function __invoke(Document $document, Request $request)
    {
        ...
        $document->content = $this->view->make('duroom.forum::frontend.content.discussion', compact('apiDocument', 'page', 'hasPrevPage', 'hasNextPage', 'getResource', 'posts', 'url'));
