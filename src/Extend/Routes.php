...
class Routes implements ExtenderInterface
{
     ...
     * or extend one of the DuRoom Api controllers within \DuRoom\Api\Controller.
     *
     * The handler should accept:
     * - \Psr\Http\Message\ServerRequestInterface $request
     * - \Tobscure\JsonApi\Document $document: If it extends one of the DuRoom Api controllers.
     *
