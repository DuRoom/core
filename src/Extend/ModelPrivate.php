 ...
 * field.
 *
 * In DuRoom core, the Discussion and CommentPost models come with private support.
...
class ModelPrivate implements ExtenderInterface
{
     ...
     * - \DuRoom\Database\AbstractModel $instance: An instance of the model.
     *
    ...
    public function extend(Container $container, Extension $extension = null)
    {
        ...
        $container->extend('duroom.database.model_private_checkers', function ($originalCheckers) use ($container) {
