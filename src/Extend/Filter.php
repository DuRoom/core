...
class Filter implements ExtenderInterface
{
     ...
     * - DuRoom\Filter\FilterState $filter
    ...
    {
        $container->extend('duroom.filter.filters', function ($originalFilters) {
        ...
        $container->extend('duroom.filter.filter_mutators', function ($originalMutators) {
