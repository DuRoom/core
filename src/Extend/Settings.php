...
class Settings implements ExtenderInterface
{
    ...
    public function extend(Container $container, Extension $extension = null)
    {
        if (! empty($this->defaults)) {
            $container->extend('duroom.settings.default', function (Collection $defaults) {
        ...
        if (! empty($this->lessConfigs)) {
            $container->extend('duroom.less.config', function (array $existingConfig, Container $container) {
