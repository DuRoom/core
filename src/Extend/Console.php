...
class Console implements ExtenderInterface
{
     ...
     *
     * @param string $command: ::class attribute of command class, which must extend DuRoom\Console\AbstractCommand.
     * @return self
     */
    ...
    {
        $container->extend('duroom.console.commands', function ($existingCommands) {
            return array_merge($existingCommands, $this->addCommands);
        });

        $container->extend('duroom.console.scheduled', function ($existingScheduled) {
