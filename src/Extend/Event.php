...
class Event implements ExtenderInterface
{
    ...
    /**
     * Add a listener to a domain event dispatched by duroom or a duroom extension.
     *
    ...
    /**
     * Add a subscriber for a set of domain events dispatched by duroom or a duroom extension.
