...
class SimpleDuRoomSearchTest extends TestCase
{
    ...
    {
        $this->extend((new Extend\SimpleDuRoomSearch(DiscussionSearcher::class))->setFullTextGambit(NoResultFullTextGambit::class));
    ...
    {
        $this->extend((new Extend\SimpleDuRoomSearch(DiscussionSearcher::class))->addGambit(NoResultFilterGambit::class));
    ...
    {
        $this->extend((new Extend\SimpleDuRoomSearch(DiscussionSearcher::class))->addSearchMutator(function ($search, $criteria) {
    ...
    {
        $this->extend((new Extend\SimpleDuRoomSearch(DiscussionSearcher::class))->addSearchMutator(CustomSearchMutator::class));
    ...
    {
        $this->extend(
            (new Extend\SimpleDuRoomSearch(CustomSearcher::class))->setFullTextGambit(CustomFullTextGambit::class)
        );
