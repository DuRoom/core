...
class ThemeTest extends TestCase
{
    ...
    public function theme_extender_override_import_doesnt_work_by_default()
    {
        ...
        $cssFilePath = $this->app()->getContainer()->make('filesystem')->disk('duroom-assets')->path('forum.css');
    ...
    public function theme_extender_can_add_custom_function()
    {
        $this->extend(
            ...
            (new Extend\Theme)
                ->addCustomLessFunction('is-duroom', function ($text) {
                    return strtolower($text) === 'duroom' ? 'true' : 100;
                })
