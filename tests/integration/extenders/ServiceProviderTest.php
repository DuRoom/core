...
class ServiceProviderTest extends TestCase
{
    ...
    public function providers_dont_work_by_default()
    {
        ...
        $this->assertIsArray(
            $this->app->getContainer()->make('duroom.forum.middleware')
        );
    }
...
class CustomServiceProvider extends AbstractServiceProvider
{
    public function register()
    {
        ...
        $this->app->extend('duroom.forum.middleware', function () {
...
class SecondCustomServiceProvider extends AbstractServiceProvider
{
    public function register()
    {
        ...
        $this->app->extend('duroom.forum.middleware', function ($forumRoutes) {
