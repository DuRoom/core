...
namespace DuRoom\Tests\integration\api\posts;
...
class ShowTest extends TestCase
{
    ...
    public function malformed_post_caught_by_renderer()
    {
        ...
        $this->assertEquals("Sorry, we encountered an error while displaying this content. If you're a user, please try again later. If you're an administrator, take a look in your DuRoom log files for more information.", $data['data']['attributes']['contentHtml']);
    }
}