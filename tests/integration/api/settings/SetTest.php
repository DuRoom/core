...
namespace DuRoom\Tests\integration\api\settings;
...
class SetTest extends TestCase
{
    ...
    public function settings_cant_be_updated_by_user()
    {
        ...
        $this->assertNotEquals('world', $this->app->getContainer()->make('duroom.settings')->get('hello'));
    }
    ...
    public function settings_can_be_updated_by_admin()
    {
        ...
        $this->assertEquals('world', $this->app->getContainer()->make('duroom.settings')->get('hello'));
    }
