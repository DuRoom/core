...
export default class ItemList<T> {
  ...
  // TODO: [DuRoom 2.0] Remove `.items` getter.
  /**
  ...
  // TODO: [DuRoom 2.0] Remove deprecated `.replace()` method.
  /**
   ...
   * methods to replace items and their priorities. This method will be removed in DuRoom 2.0.
   *
   ...
   *
   * @see https://github.com/duroom/core/issues/3030
   */
