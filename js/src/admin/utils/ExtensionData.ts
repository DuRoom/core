...
export default class ExtensionData {
   ...
   *
   * @example
   * app.extensionData.for('duroom-tags')
   *
   * duroom/flags -> duroom-flags | acme/extension -> acme-extension
   */
  ...
  /**
   * This function registers your settings with DuRoom
   *
  ...
  /**
   * This function registers your permission with DuRoom
   *
   * @example
   *
