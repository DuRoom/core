...
export declare type DuRoomScreens = 'phone' | 'tablet' | 'desktop' | 'desktop-hd';
export declare type DuRoomGenericRoute = RouteItem<any, any, any>;
...
export default class Application {
     ...
     */
    protected requestErrorCatch<ResponseType>(error: RequestError, customErrorHandler: DuRoomRequestOptions<ResponseType>['errorHandler']): Promise<never>;
