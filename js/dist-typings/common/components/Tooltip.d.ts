...
export interface TooltipAttrs extends Mithril.CommonAttributes<TooltipAttrs, Tooltip> {
     ...
     * tooltip library. Be prepared for this to break in DuRoom stable.
     *
     * Default: `false`.
     *
     * @deprecated
     ...
     * library. Be prepared for this to break in DuRoom stable.
     *
     * Default: `0`.
     *
     * @deprecated
 ...
 * DuRoom. This shouldn't be an issue if you're using this component correctly.
 *
